...
\renewcommand{\lstlistlistingname}{List of \lstlistingname}% List of Listings -> List of Algorithms
...
\renewcommand\nomgroup[1]{%
  \item[\bfseries
  \ifstrequal{#1}{0-nota}{Notations}{
  \ifstrequal{#1}{1-sym}{Symbols}{
  \ifstrequal{#1}{2-abb}{Abbreviations}{}}}%
]}
% -----------------------------------------
