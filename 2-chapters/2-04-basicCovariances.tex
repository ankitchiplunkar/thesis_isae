...
$k(x_{i}, x_{j})$ corresponds to a covariance function if it is a symmetric PSD function \cite{loeve1978probability, durrande2001etude}. Consider for a new random vector $T = \sum \alpha_{i}f(x_{i})$:
