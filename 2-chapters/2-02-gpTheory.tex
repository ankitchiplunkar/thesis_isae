...
\marginnote{\textsl{GP regression work-flow}}[1cm]
...
\marginnote{\textsl{Figure \ref{figGPNoiseLessPosteriors}}}[1cm]
...
\marginnote{\textsl{Figure \ref{figGPNoisyPosteriors}}}[1cm]
...
\marginnote{\textsl{$\mathcal{O}\left ( N^{3} \right )$}}[-1cm]
...
\marginnote{\textsl{$\mathcal{O}\left ( N \right )$}}[1cm]  
...
The mean and variance are highly dependent on the hyper-parameters. In order to automatically learn the hyper-parameters, we must perform model selection. Section \ref{secHyperParameter} details how to fine-tune hyper-parameters to find an optimal prediction.
...
\marginnote{\textsl{data-set $\mathcal{D}_{2}$}}[1cm]
...
\marginnote{\textsl{Figure \ref{figGPRMarginal}}}[1cm]
...
\marginnote{\textsl{Trade-off}}[1cm]
...
\marginnote{\textsl{Section \ref{secPrior}}}[1cm]
...
\marginnote{\textsl{Section \ref{secPosterior}}}[1cm]
...
\marginnote{\textsl{Section \ref{secHyperParameter}}}[1cm]
