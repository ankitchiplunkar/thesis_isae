...
Suppose we have a dataset \(\mathcal{D} = \{X = [-0.5, 0.33, 0.66], Y = [0, 0.5, 0.5]\}\) and want to perform Bayesian Linear Regression on it. We would assume a prior distribution of parameter \(w\):
\begin{equation}
\begin{Bmatrix}
w_{0}\\ 
w_{1}
